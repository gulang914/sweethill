    ...
    <div id="f1">
        ...
        <div class="am-container ">
            <div class="shopTitle ">
                ...
                <div class="today-brands ">
                    @foreach($cates['0'] as $a)
                        <a href="/goods/{{ $a->id }}">{{ $a->cate_name }}</a>
                    @endforeach
                </div>
            </div>
        </div>
        ...
        <div class="am-g am-g-fixed floodFour">
            ...
            <div class="am-u-sm-7 am-u-md-4 text-two sug">
                <div class="outer-con ">
                    <div class="title ">
                        {{ $goods['0']['0']->goods_name }}
                    </div>
                    <div class="sub-title ">
                        ¥{{ $goods['0']['0']->goodsdetail->goods_price }}
                    </div>
                    <i class="am-icon-shopping-basket am-icon-md  seprate"></i>
                </div>
                <a href="/goods/detal/show/{{ $goods['0']['0']->id }}"><img src="{{ $goods['0']['0']->goods_photo }}" /></a>
            </div>

            <div class="am-u-sm-7 am-u-md-4 text-two">
                <div class="outer-con ">
                    <div class="title ">
                        {{ $goods['1']['0']->goods_name }}
                    </div>
                    <div class="sub-title ">
                        ¥{{ $goods['1']['0']->goodsdetail->goods_price }}
                    </div>
                    <i class="am-icon-shopping-basket am-icon-md  seprate"></i>
                </div>
                <a href="/goods/detal/show/{{ $goods['1']['0']->id }}"><img src="{{ $goods['1']['0']->goods_photo }}" /></a>
            </div>
            ...
            <div class="am-u-sm-3 am-u-md-2 text-three big">
                <div class="outer-con ">
                    <div class="title ">
                        {{ $goods['2']['0']->goods_name }}
                    </div>
                    <div class="sub-title ">
                        ¥{{ $goods['2']['0']->goodsdetail->goods_price }}
                    </div>
                    <i class="am-icon-shopping-basket am-icon-md  seprate"></i>
                </div>
                <a href="/goods/detal/show/{{ $goods['2']['0']->id }}"><img src="{{ $goods['2']['0']->goods_photo }}" /></a>
            </div>

            <div class="am-u-sm-3 am-u-md-2 text-three sug">
                <div class="outer-con ">
                    <div class="title ">
                        {{ $goods['3']['0']->goods_name }}
                    </div>
                    <div class="sub-title ">
                        ¥{{ $goods['3']['0']->goodsdetail->goods_price }}
                    </div>
                    <i class="am-icon-shopping-basket am-icon-md  seprate"></i>
                </div>
                <a href="/goods/detal/show/{{ $goods['3']['0']->id }}"><img src="{{ $goods['3']['0']->goods_photo }}" /></a>
            </div>

            <div class="am-u-sm-3 am-u-md-2 text-three ">
                <div class="outer-con ">
                    <div class="title ">
                        {{ $goods['1']['1']->goods_name }}
                    </div>
                    <div class="sub-title ">
                        ¥{{ $goods['1']['1']->goodsdetail->goods_price }}
                    </div>
                    <i class="am-icon-shopping-basket am-icon-md  seprate"></i>
                </div>
                <a href="/goods/detal/show/{{ $goods['1']['1']->id }}"><img src="{{ $goods['1']['1']->goods_photo }}" /></a>
            </div>

            <div class="am-u-sm-3 am-u-md-2 text-three last big ">
                <div class="outer-con ">
                    <div class="title ">
                        {{ $goods['3']['1']->goods_name }}
                    </div>
                    <div class="sub-title ">
                        ¥{{ $goods['3']['1']->goodsdetail->goods_price }}
                    </div>
                    <i class="am-icon-shopping-basket am-icon-md  seprate"></i>
                </div>
                <a href="/goods/detal/show/{{ $goods['3']['1']->id }}"><img src="{{ $goods['3']['1']->goods_photo }}" /></a>
            </div>
